...
import trade.mozan.adapter.UsersAdapter;
...
import trade.mozan.lib.PullToRefreshBase;
import trade.mozan.lib.PullToRefreshListView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        createChatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((AppController)getActivity().getApplication()).addDialogsUsers(usersAdapter.getSelected());
