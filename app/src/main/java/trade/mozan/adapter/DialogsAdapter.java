...
public class DialogsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(dialog.getType().equals(QBDialogType.GROUP)){
            ...
            //
            Integer opponentID = ((AppController)ctx.getApplication()).getOpponentIDForPrivateDialog(dialog);
            QBUser user = ((AppController)ctx.getApplication()).getDialogsUsers().get(opponentID);
            if(user != null){
